             ...
             <ul>
               ...
               <li class="flex items-start py-2">
                 ...
                 <p class="text-cyan-50 flex flex-wrap text-sm md:px-5 md:text-lg">
                   ...
                   {"HTML, CSS, JavaScript, TypeScript, Rust, Yew, Tauri, React.js, Vue.js, Node.js, Python, Java, Kotlin, \
             ...
             <ul>
               <li class="flex items-start py-2">
                 ...
                 <p class="text-cyan-50 flex flex-wrap text-sm md:px-5 md:text-lg">
                   ...
                   Durante los años 2019, 2020, 2021 y 2022, en el Real Club Labradores de Sevilla \
