            ...
            <div class="flex flex-col gap-4 mt-4">
              <div>
                  <Link<Route> to={Route::Home}>
                    <span
                      class={classes!(if &*props.activeroute == "/portfolio_cv/" {"active-route"} else {""}, link_style)}
              ...
              <div>
                  <Link<Route> to={Route::MyCV}>
                    <span class={classes!(if &*props.activeroute == "/portfolio_cv/mycv" {"active-route"} else {""}, link_style)}
